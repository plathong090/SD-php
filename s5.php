...
<body>
    ...
    <?php //lab8-5 fixed summation of multiples of 5
    ...
    function show_form()
    {
        echo ' <form method="get" action="s5.php">';
    ...
    if (isset($_GET['num1']) && isset($_GET['num2'])) {
        $n1 = intval($_GET['num1']); //intval แปลงเป็นจำนวนเต็มฐาน10
        $n2 = intval($_GET['num2']);
